...
#define SELF_SCALE_TO_SIZE(type) MultidimArray<type> *mdaFloat; \
 ...
 selfScaleToSize(xmippTransformation::LINEAR, *mdaFloat, (int)w, (int)h);
...
(JNIEnv * env, jobject jobj, jobject jimg)
{
    XMIPP_JAVA_TRY
    {
        ...
        for (size_t i=0; i < dim.ndim; ++i)
        {
            ...
            applyGeometry(xmippTransformation::LINEAR, tmpI, tmpI2, alignmentM, xmippTransformation::IS_NOT_INV, true);
	...
	XMIPP_JAVA_TRY
	   {
		   ...
		   applyGeometry(xmippTransformation::LINEAR, Iaux, *I, transformM, xmippTransformation::IS_NOT_INV, wrap);
           *I=Iaux;
	   }
	   XMIPP_JAVA_CATCH;
